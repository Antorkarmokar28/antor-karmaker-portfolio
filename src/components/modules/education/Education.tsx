...
export default function Education() {
  return (
    <div className="text-gray-200 py-10 px-6 mt-20">
      <div className="container mx-auto px-4 md:px-6">
        <h1 className="text-4xl text-center font-bold mb-6 text-[#00ff99]">
          Education
        </h1>
        <div className="p-6 border-t-2 border-b-2 border-[#00ff99] rounded-xl md:flex items-center justify-center gap-6">
          <div>
            {/* education image */}
            <Image
              src={educationImage}
